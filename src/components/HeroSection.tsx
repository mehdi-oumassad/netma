...
import { motion } from 'framer-motion'; // Correction de l'import pour la compatibilité
          ...
          >
            ...
            <div className="mt-4 flex flex-wrap items-center justify-center gap-4 lg:justify-start">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="rounded-full bg-white px-8 py-3.5 text-sm font-semibold tracking-wide text-[#050505] transition-all hover:bg-zinc-200 inline-block"
              >
                {t('hero.cta_primary')}
              </motion.a>
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="rounded-full border border-zinc-800 bg-transparent px-8 py-3.5 text-sm font-semibold tracking-wide text-white transition-all hover:bg-zinc-900 inline-block"
              >
